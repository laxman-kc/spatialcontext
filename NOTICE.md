...
AirScape's [dataset card](https://huggingface.co/datasets/EmbodiedCity/AirScape-Dataset) reserves original video rights to the source owners. Individual redistribution permission for the demonstrated clip was not established. Raw footage, sampled frames, the annotated recording, its GIF and its poster are therefore excluded from the public branch and source distributions. They remain in the private maintainer handoff.

The public release includes numerical results, source URLs, timestamps and hashes describing that run. Its historical provenance receipt records media hashes without distributing the media. Obtain any needed permission independently before redistributing source footage or recreating a public video demonstration.
